...
<title>用户信息核对</title>
<link rel="stylesheet" href="http://localhost/product/ymgshop/YMGSHOP/Index/View/Cart/css/order.css" />
...
URL = 'http://localhost/product/ymgshop/index.php/Index/Cart/order';
...
ACTION = 'http://localhost/product/ymgshop/index.php/Index/Cart/order';
...
HISTORY = 'http://localhost/product/ymgshop/index.php/Index/Cart/index';
</script>
<script type="text/javascript" src="http://localhost/product/ymgshop/YMGSHOP/Index/View/Cart/js/order.js"></script>
</head>
<body>
	<!-- top start-->
	<div id="top">
	...
	<!-- top end -->
	<div id="big" url="http://localhost/product/ymgshop/index.php">
		<div class="logo">
									...
									<form name="payway" >
										...
										<div class="nr">
											<p class="xz1">
												<label>
												<span>
													<input type="radio" name="radio_PayType" onclick="checkeds();"value="1" />	
										...
										<div class="nr2">
											<p class="xz">
												<label >
												<span>                                    
													<input name="radio_PayType" onclick="checkeds();" class="radio_PayType" value="2" type="radio" way="在线支付"> 
											...
											<td> 
												<div class="f_l m_l65 t_al"> 
													<a href="<?php echo U('detail',array('gid'=>$d['gid']));?>">
														<img src="http://localhost/product/ymgshop/<?php echo $d['img'];?>" name="<?php echo $d['goods_name'];?>" height="53" width="39">
													</a>
												</div>
...
echo "";
											...
											<td>
												<span class="c_d90077">
													<b class="price_icon" >￥</b><?php echo $d['totalPrice'];?>
												</span>
											</td>
										</tr>
							...
							<table class="Money_Block">
								<tbody>
									<tr>
										...
										<td class="t_ar">
											<span class="c_d90077">
												<span class="price_icon">￥</span> <?php echo $_SESSION['cart']['totalPrice'];?>
											</span> 
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="t_ar">
											<span class="c_d90077">
												...
												<span class="jine"><?php echo $_SESSION['cart']['totalPrice'];?></span>
											</span>
										</td>
									</tr>
								</tbody>
