...
URL = 'http://localhost/product/ymgshop/index.php/Admin/Role/index';
...
CONTROLLER = 'http://localhost/product/ymgshop/index.php/Admin/Role';
ACTION = 'http://localhost/product/ymgshop/index.php/Admin/Role/index';
...
CONTROLLERVIEW = 'http://localhost/product/ymgshop/YMGSHOP/Admin/View/Role';
...
<body>
	<div class="warp">
		...
		<table class="table2">
			<thead>
				<tr>
					<td class="w200">rid</td>
					<td class="w450">角色描述</td>
					<td class="w450">操作<td>
				</tr>
			</thead>
			<tbody>
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
				...
				<tr>
					...
					<td>
						<a href="<?php echo U('Access/set',array('rid'=>$d['rid']));?>">权限设置</a> | 
						<a href="<?php echo U('edit',array('rid'=>$d['rid']));?>">编辑</a> | 
						<a href="<?php echo U('delete',array('rid'=>$d['rid']));?>">删除</a>
					</td>
				</tr>
