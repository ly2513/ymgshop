...
URL = 'http://localhost/ymgshop/index.php/Admin/GoodsType/edit/cat_id/1';
...
ACTION = 'http://localhost/ymgshop/index.php/Admin/GoodsType/edit';
...
HISTORY = 'http://localhost/ymgshop/index.php/Admin/GoodsType/index';
</script>
<title>修改商品类型</title>
</head>
<body>
	<div class="warp">
	<div class="menu_list action">
		<ul>
			<li><a href="<?php echo U('index');?>">商品类型列表</a></li>
			<li><a href="<?php echo U('add');?>">添加商品类型</a></li>
		</ul>
	</div>
		<div class="title-header">修改商品类型</div>
		<form  method="post">
		<input type="hidden"  value="<?php echo $field['cat_id'];?>" />
			<table class="table2 hd-form">	
				<tr>
					<th class="w100">商品类型名称</th>
					<td>
						<input type="text" class="w200"  name="cat_name" value="<?php echo $field['cat_name'];?>" />
					</td>
				</tr>
				<tr>
					<th></th>
